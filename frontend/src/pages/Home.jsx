...
import { Sparkles, TrendingUp, Clock, User, Tag, ArrowRight, Heart, Share2, Bookmark } from 'lucide-react';
...
export default function Home() {
  ...
  useEffect(() => {
    const data = [
      ...
      {
        id: 4,
        title: "Oprah Winfrey: Global Media Phenomenon",
        author: "Entertainment Insider",
        category: "Entertainment",
        date: "2025-04-01",
        image: "https://images.pexels.com/photos/3184291/pexels-photo-3184291.jpeg?auto=compress&cs=tinysrgb&w=800",
        content: "Oprah Winfrey became a global media icon and philanthropist, inspiring millions through her authentic storytelling.",
        readTime: "4 min read",
        likes: 267,
      ...
      {
        id: 5,
        title: "Einstein's Mind-Bending Theories",
        author: "Physics Explorer",
        category: "Science",
        date: "2025-05-10",
        image: "https://images.pexels.com/photos/714698/pexels-photo-714698.jpeg?auto=compress&cs=tinysrgb&w=800",
        content: "Albert Einstein developed the theory of relativity, fundamentally changing our understanding of space and time.",
        readTime: "8 min read",
        likes: 445,
      ...
      },
      {
        ...
        content: "Leonardo da Vinci embodied the Renaissance spirit, excelling in art, science, engineering, and innovation.",
        readTime: "6 min read",
        likes: 298,
...
<nav className="fixed top-0 left-0 w-full z-50 bg-black/30 backdrop-blur-md border-b border-white/10">
  <div className="max-w-7xl mx-auto px-6 py-4 flex justify-between items-center">
    {/* Logo */}
    <Link to="/" className="text-2xl font-bold bg-gradient-to-r from-pink-400 to-cyan-400 bg-clip-text text-transparent">
      InspiringStories
    </Link>
      ...
      <div className="relative min-h-screen flex flex-col justify-center items-center text-white px-4">
        <div className="text-center z-10 max-w-4xl">
          ...
          <p className="text-xl md:text-3xl mb-8 font-medium opacity-90 leading-relaxed">
            Discover extraordinary journeys of <span className="text-yellow-400 font-bold">visionaries</span>, 
          ...
          {filteredBlogs.slice(0, 3).map((blog, index) => (
            ...
            >
              <div className="relative overflow-hidden">
                ...
                />
                <div className={`absolute inset-0 bg-gradient-to-t ${blog.gradient} opacity-60 mix-blend-overlay`}></div>
              ...
              <div className="p-6">
                <div className="flex items-center gap-2 mb-3">
                  <span className={`px-3 py-1 rounded-full text-xs font-bold bg-gradient-to-r ${blog.gradient} text-white`}>
                    {blog.category}
                  </span>
                ...
                <p className="text-white/80 mb-4 text-sm leading-relaxed">{blog.content}</p>
            ...
            >
              <div className="relative overflow-hidden">
                ...
                <div className="absolute top-4 left-4">
                  <span className={`px-3 py-1 rounded-full text-xs font-bold bg-gradient-to-r ${blog.gradient} text-white shadow-lg`}>
                    {blog.category}
                  </span>
                </div>
              </div>
      ...
      <footer className="relative z-10 mt-20 bg-gradient-to-r from-gray-900 via-purple-900 to-gray-900 text-white py-12">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-8">
            ...
            <p className="text-white/70 mb-6">Join our community of story lovers and never miss an inspiring tale.</p>
